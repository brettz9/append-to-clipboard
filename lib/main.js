...
exports.main = function () {
    ...
    var simplePrefs = require('sdk/simple-prefs'),
        ...
        labels = [
            ['noSeparator', 'Append to Clipboard (no separator)', ''],
            ['lineBreakSeparator', 'Append to Clipboard (Line break separator)', {text: '\n', html: '<br />\n'}],
            ['doubleLineBreakSeparator', 'Append to Clipboard (Double line break separator)', {text: '\n\n', html: '<br /><br />\n'}]            
